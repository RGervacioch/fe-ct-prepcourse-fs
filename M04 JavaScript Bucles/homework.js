...
function mayoriaDeEdad(edad) {
   ...
   // Tu código:
   if (edad > 17 && edad <= 60) return "Allowed"
   return "Not allowed"
}
var resultado1 = mayoriaDeEdad(16)
...
function esPrimo(num) {
   ...
   // Tu código:
   // num primo es divisible por 1 y por si mismo
   // 2, 3, 5, 7
...
console.log(tieneTresDigitos(44))
